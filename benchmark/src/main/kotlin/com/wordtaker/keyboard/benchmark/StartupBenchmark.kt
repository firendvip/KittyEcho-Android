...
package com.wordtaker.keyboard.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        packageName = "com.wordtaker.keyboard",
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable com.wordtaker.keyboard/.FlorisImeService")
            device.executeShellCommand("ime set com.wordtaker.keyboard/.FlorisImeService")
        }
    ) {

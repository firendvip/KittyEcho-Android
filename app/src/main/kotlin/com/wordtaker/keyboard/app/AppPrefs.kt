...
import com.wordtaker.keyboard.app.settings.theme.ColorPreferenceSerializer
import com.wordtaker.keyboard.app.settings.theme.DisplayKbdAfterDialogs
import com.wordtaker.keyboard.app.settings.theme.SnyggLevel
import com.wordtaker.keyboard.app.setup.NotificationPermissionState
import com.wordtaker.keyboard.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
import com.wordtaker.keyboard.ime.clipboard.ClipboardSyncBehavior
...
import com.wordtaker.keyboard.ime.input.HapticVibrationMode
import com.wordtaker.keyboard.ime.input.InputFeedbackActivationMode
import com.wordtaker.keyboard.ime.keyboard.IncognitoMode
import com.wordtaker.keyboard.ime.keyboard.SpaceBarMode
import com.wordtaker.keyboard.ime.landscapeinput.LandscapeInputUiMode
import com.wordtaker.keyboard.ime.media.emoji.EmojiHairStyle
import com.wordtaker.keyboard.ime.media.emoji.EmojiHistory
import com.wordtaker.keyboard.ime.media.emoji.EmojiSkinTone
import com.wordtaker.keyboard.ime.media.emoji.EmojiSuggestionType
import com.wordtaker.keyboard.ime.nlp.SpellingLanguageMode
import com.wordtaker.keyboard.ime.smartbar.CandidatesDisplayMode
import com.wordtaker.keyboard.ime.smartbar.ExtendedActionsPlacement
import com.wordtaker.keyboard.ime.smartbar.IncognitoDisplayMode
import com.wordtaker.keyboard.ime.smartbar.SmartbarLayout
import com.wordtaker.keyboard.ime.smartbar.quickaction.QuickAction
import com.wordtaker.keyboard.ime.smartbar.quickaction.QuickActionArrangement
import com.wordtaker.keyboard.ime.smartbar.quickaction.QuickActionJsonConfig
import com.wordtaker.keyboard.ime.text.gestures.SwipeAction
import com.wordtaker.keyboard.ime.text.key.KeyCode
import com.wordtaker.keyboard.ime.text.key.KeyHintConfiguration
import com.wordtaker.keyboard.ime.text.key.KeyHintMode
import com.wordtaker.keyboard.ime.text.key.UtilityKeyAction
import com.wordtaker.keyboard.ime.text.keyboard.TextKeyData
import com.wordtaker.keyboard.ime.theme.ThemeMode
import com.wordtaker.keyboard.ime.theme.extCoreTheme
import com.wordtaker.keyboard.ime.window.ImeWindowConfig
import com.wordtaker.keyboard.lib.ext.ExtensionComponentName
import com.wordtaker.keyboard.lib.util.VersionName
...
import com.wordtaker.lib.android.isOrientationPortrait
...
abstract class FlorisPreferenceModel : PreferenceModel() {
    ...
    inner class Gestures {
        ...
        val spaceBarLongPress = enum(
            ...
            // WordTaker: long-press space triggers the cat voice overlay (NOT the
            // system IME picker / subtype switch).
            default = SwipeAction.TRIGGER_VOICE_INPUT,
        )
    ...
    inner class Internal {
        ...
        /**
         * Chinese keyboard style chosen during first-launch onboarding.
         * Values: "qwerty_pinyin" (全键盘拼音, default, most stable) or "t9_pinyin" (九宫格拼音).
         * Read by [com.wordtaker.keyboard.ime.core.SubtypeManager] when seeding the default
         * pinyin subtype so the chosen layout drives the keyboard.
         */
        val selectedKeyboardStyle = string(
            key = "internal__selected_keyboard_style",
            default = "qwerty_pinyin",
        )
    ...
    inner class Keyboard {
        ...
        val hintedNumberRowEnabled = boolean(
            ...
            // WordTaker: WeChat-style minimal keyboard has no 1-0 number hint row.
            default = false,
        )
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.wordtaker.keyboard.ime.media.emoji.Emoji(it, "", emptyList())
                }

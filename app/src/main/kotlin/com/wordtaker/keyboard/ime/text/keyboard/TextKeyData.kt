...
import com.wordtaker.keyboard.lib.Unicode
...
data class TextKeyData(
    ...
    companion object {
        ...
        /** Predefined key data for [KeyCode.IME_UI_MODE_CAT_VOICE] */
        val IME_UI_MODE_CAT_VOICE = TextKeyData(
            type = KeyType.SYSTEM_GUI,
            code = KeyCode.IME_UI_MODE_CAT_VOICE,
            label = "ime_ui_mode_cat_voice",
        )

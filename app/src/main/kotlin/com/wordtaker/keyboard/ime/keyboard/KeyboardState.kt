...
import com.wordtaker.keyboard.ime.sheet.isAnyBottomSheetVisible
...
open class KeyboardState protected constructor(open var rawValue: ULong) {
    ...
    var isEnglishMode: Boolean
        get() = getFlag(F_IS_ENGLISH_MODE)
        set(v) { setFlag(F_IS_ENGLISH_MODE, v) }
